...
import { mountSuikaRenderer } from "./renderers/suika/mountSuikaRenderer";
import "./styles/suika.css";
...
function createLoadingView(): {
  ...
  const fill = loading.querySelector<HTMLDivElement>(".suika-loading-fill");
  const text = loading.querySelector<HTMLDivElement>(".suika-loading-text");
...
void bootstrap().catch((error: unknown) => {
  const loadingText = document.querySelector<HTMLDivElement>(".suika-loading-text");
